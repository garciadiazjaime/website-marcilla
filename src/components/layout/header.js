            ...
            <Navbar brand={<Link to="home" title="Marcilla | Volver a inicio">Marcilla | Volver a inicio</Link>} toggleNavKey={0}  className="navbar-static-top">
                <CollapsibleNav eventKey={0}> {/* This is the eventKey referenced */}
                  <Nav navbar>
                    ...
                    <NavItem eventKey={2} href={this.state.STORE_URL}>Catálogo</NavItem>
                ...
                <a href={this.state.STORE_URL + "/basket/"} id="shopping-cart"><span id="basket_total_items"></span><span>Item in car</span></a>
                <SocialWidget />
            </Navbar>
        );
    }
